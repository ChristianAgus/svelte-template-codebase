        ...
        <ul class="nav-main">
          ...
          <li class="nav-main-item open">
            ...
            <ul class="nav-main-submenu">
              <li class="nav-main-item">
                <a class="nav-main-link" href="/hero/simple/1">
                  <span class="nav-main-link-name">Hero Simple 1</span>
                </a>
              </li>
              <li class="nav-main-item">
                <a class="nav-main-link" href="/hero/simple/2">
                  <span class="nav-main-link-name">Hero Simple 2</span>
                </a>
              </li>
              <li class="nav-main-item">
                <a class="nav-main-link" href="/hero/simple/3">
                  <span class="nav-main-link-name">Hero Simple 3</span>
                </a>
              </li>
              <li class="nav-main-item">
                <a class="nav-main-link" href="/hero/simple/4">
